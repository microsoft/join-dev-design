            ...
            : void 0 !== (o = W[this.stream.peekChar()])
              ...
              : this.stream.peekChar(0) === m && this.stream.peekChar(1) === f
                ...
                : this.stream.peekChar(0) === g && this.stream.peekChar(1) === f
                  ...
                  : this.stream.peekChar(0) === v &&
                    this.stream.peekChar(1) === f
                    ? (this.stream.advance(2),
                      this.finishToken(e, a.SubstringOperator))
                    : this.stream.peekChar(0) === u &&
                      this.stream.peekChar(1) === f
                      ? (this.stream.advance(2),
                        this.finishToken(e, a.PrefixOperator))
                      : this.stream.peekChar(0) === E &&
                        this.stream.peekChar(1) === f
                        ? (this.stream.advance(2),
                          this.finishToken(e, a.SuffixOperator))
                                ...
                                : s instanceof w.Function
                                  ...
                                  : s instanceof w.Supports
                                    ...
                                    : s instanceof w.SupportsCondition
                                      ? this.getCompletionsForSupportsCondition(
                                          s,
                                          r
                                        )
                ...
                return (
                  e instanceof c.Selector
                    ...
                    : e instanceof c.VariableDeclaration
                      ? ((t.name = e.getName()),
                        (t.kind = h.SymbolKind.Variable))
                      : e instanceof c.MixinDeclaration
                        ? ((t.name = e.getName()),
                          (t.kind = h.SymbolKind.Method))
                        : e instanceof c.FunctionDeclaration
                          ? ((t.name = e.getName()),
                            (t.kind = h.SymbolKind.Function))
